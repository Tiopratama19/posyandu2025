            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Data Riwayat <b>{{ $dataremaja->Nama }}</b></h4>
                    ...
                    <div class="card-body p-4">
                        ...
                        @endif
                        <div class="row">
                            <form class="col-12 col-lg-12" action="{{ route('dataremaja.riwayat-store', $dataremaja->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
