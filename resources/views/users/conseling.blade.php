                    ...
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="simple-tab-0-{{ $item->id }}" data-bs-toggle="tab"
                                    href="#simple-tabpanel-0-{{ $item->id }}" role="tab"
                                    aria-controls="simple-tabpanel-0-{{ $item->id }}" aria-selected="true">Daftar</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="simple-tab-1-{{ $item->id }}" data-bs-toggle="tab"
                                    href="#simple-tabpanel-1-{{ $item->id }}" role="tab"
                                    aria-controls="simple-tabpanel-1-{{ $item->id }}" aria-selected="false">Peserta</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="simple-tabpanel-0-{{ $item->id }}" role="tabpanel"
                                ...
                                <form id="data-master-{{ $item->id }}" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" id="simpan-data" class="btn btn-primary simpan-data"
                                            data-id="{{ $item->id }}">
